...
const Introduction = () => {
  return (
    <div className="container-fluid bg-neutral-white py-12 py-lg-24 d-flex position-relative">
      <div className="container">
        <div className="row align-items-center justify-content-between">
          <div className="col-4 intro-img position-relative d-none d-lg-block">
            <img src={Intro} alt="" className="" />
          </div>
          <div className="col col-lg-7 p-0 p-lg-9 intro-word position-relative">
            <h3 className="text-secondary mb-6">
              來喵喵派對，為你的毛孩子挑選牠最愛的派對必備品，讓牠的生活每天都像過節一樣快樂吧！
            </h3>
            <p className="text-gray-400 fs-7 fs-lg-6">
