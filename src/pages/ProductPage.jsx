        ...
        <div className="row">
            ...
            <div className="row">
              {productData.imagesUrl.map((url, index) => (
                <div className="col-4" key={index}>
                  <img src={url} className="img-display object-fit-cover mb-3 rounded" alt={productData.title} />
                </div>
              ))}
            </div>
          </div>
          <div className="col-md-5">
            <div className="d-flex justify-content-between align-items-center">
              <h2 className="fs-2 text-secondary fw-bold">{productData.title}</h2>
              <span className="material-symbols-rounded text-secondary-light" role="button">favorite</span>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="cart-qty-group d-flex flex-nowrap flex-shrink-0 flex-grow-1">
                <button className="btn bg-gray-100 rounded-0 rounded-start-circle d-flex align-items-center" type="button" onClick={handleDecrement}><span className="material-symbols-rounded">remove</span></button>

                <input type="text" className="form-control text-center bg-gray-100 border-0 rounded-0" placeholder='1' id="quantity" value={quantity} onChange={handleQuantityChange} min="1" readOnly />
                
                <button className="btn bg-gray-100 rounded-0 rounded-end-circle d-flex align-items-center" type="button" ><span className="material-symbols-rounded" onClick={handleIncrement}>add</span></button>
              </div>
            </div>

            <button type="button" className="btn btn-primary w-100 text-white">加入購物車</button>
          </div>
          ...
          <div ref={reviewsRef} className="mt-4">
            <div className="d-flex align-items-center justify-content-start gap-8 mb-4">
              <div>
                ...
                <div className="text-primary-light">
                  <span className="material-symbols-rounded fill-icon">star</span>
                  <span className="material-symbols-rounded fill-icon">star</span>
                  <span className="material-symbols-rounded fill-icon">star</span>
                  <span className="material-symbols-rounded fill-icon">star</span>
                  <span className="material-symbols-rounded fill-icon">star</span>
              ...
              <div className="d-flex flex-column">
                <div className="d-flex align-items-center mb-1">
                  ...
                  <span className="material-symbols-rounded fill-icon text-primary-light me-4">star</span>
                  <div className="progress me-4" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">
            ...
            <div className="d-flex flex-column gap-4">
              <div className="mb-4 text-secondary">
                ...
                <p className="text-gray-400">家裡的挑嘴貓咪終於找到愛吃的罐頭了！鮮嫩多汁，光是打開罐頭香味就讓牠迫不及待開動了！</p>
              </div>
              <div className="mb-4 text-secondary">
                ...
                <p className="text-gray-400">我家貓咪體質敏感，很難找到合適的主食罐，但這款雞肉餐罐完全沒問題！毛孩吃得開心，我也安心。</p>
              </div>
              <div className="mb-4 text-secondary">
                ...
                <p className="text-gray-400">這款罐頭不僅有新鮮雞肉，還沒有奇怪的添加物，真的是毛孩健康的好選擇，每天吃得津津有味！</p>
              </div>
              <div className="mb-4 text-secondary">
                ...
                <p className="text-gray-400">質地軟嫩又多湯汁，我家年紀大的貓咪也吃得很輕鬆，非常推薦這款罐頭！</p>
              </div>
            </div>
